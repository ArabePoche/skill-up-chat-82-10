      ...
      <div className="p-6">
        <div className="flex items-center space-x-4">
          <div className="relative">
            <div className="w-20 h-20 bg-gradient-to-r from-edu-primary to-edu-secondary rounded-full flex items-center justify-center">
              {profile?.avatar_url ? (
                <img 
            ...
            <button 
              ...
              className="absolute bottom-0 right-0 bg-edu-primary text-white p-1 rounded-full"
            >
              <Edit size={12} />
            </button>
          </div>
