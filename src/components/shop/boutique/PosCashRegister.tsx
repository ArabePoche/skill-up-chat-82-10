/**
 * Caisse enregistreuse POS plein écran
 * Interface dédiée avec grille produits, panier, clavier numérique,
 * encaissement avec rendu monnaie, et génération de ticket/devis
 */
...
type PosStep = 'browse' | 'checkout' | 'payment';
...
const PosCashRegister: React.FC<PosCashRegisterProps> = ({
  ...
  // Quantité dans le panier pour un produit
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 bg-white flex flex-col">
        {/* Top Bar */}
        <div className="bg-gradient-to-r from-emerald-700 to-emerald-600 text-white px-4 py-2.5 flex items-center justify-between shrink-0">
          ...
          <div className="flex items-center gap-2 text-xs">
            ...
            <div className="bg-white/20 rounded-lg px-3 py-1.5 font-bold text-base">
                ...
                {filteredProducts.map(product => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="font-bold text-emerald-600 text-sm">{formatCurrency(product.price)}</p>
                      <p className="text-[10px] text-gray-400">Stock: {remaining}</p>
                        ...
                        return (
                          <div key={item.product.id} className="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-50 group">
                            ...
                            <button
                              ...
                              className="w-6 h-6 flex items-center justify-center text-gray-300 hover:text-red-500 opacity-0 group-hover:opacity-100 transition-opacity"
                            >
                              <X size={12} />
                            </button>
                          </div>
                ...
                {cartItems.length > 0 && (
                  <div className="border-t p-4 space-y-3">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      <Button
                        onClick={() => { setCheckoutType('sale'); setStep('checkout'); }}
                      ...
                      <Button
                        variant="outline"
                        onClick={() => { setCheckoutType('quote'); setStep('checkout'); }}
              ...
              <div className="flex flex-col h-full">
                ...
                <ScrollArea className="flex-1">
                  <div className="p-4 space-y-4">
                    ...
                    {/* Montant reçu + rendu monnaie (espèces uniquement) */}
