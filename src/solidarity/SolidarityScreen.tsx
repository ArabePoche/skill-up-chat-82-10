...
import { useSolidarityCampaigns, SolidarityCampaign } from './hooks/useSolidarityCampaigns';
...
const SolidarityScreen: React.FC = () => {
  ...
  const [selectedCampaign, setSelectedCampaign] = useState<SolidarityCampaign | null>(null);
  ...
  const filtered = useMemo(() => {
    ...
    switch (sortBy) {
      case 'popular':
        list.sort((a, b) => b.collected_amount - a.collected_amount);
        break;
      case 'ending_soon':
        list.sort((a, b) => {
      ...
      case 'almost_done':
        list.sort((a, b) => {
          const pa = a.goal_amount > 0 ? a.collected_amount / a.goal_amount : 0;
          const pb = b.goal_amount > 0 ? b.collected_amount / b.goal_amount : 0;
          return pb - pa;
        });
        break;
      default: // recent
    ...
    return list;
  }, [campaigns, sortBy, showMyOnly, user?.id]);
