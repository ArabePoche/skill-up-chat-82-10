 ...
 * Logique WhatsApp : téléchargement manuel, stockage local, vérification de présence
 */
...
export const useFileDownload = ({
  ...
  /**
   * Télécharge le fichier et le stocke localement
   */
    ...
    try {
      ...
      if (total > 0 && response.body) {
        ...
        while (true) {
          ...
          // Convertir en ArrayBuffer pour éviter les problèmes de type
