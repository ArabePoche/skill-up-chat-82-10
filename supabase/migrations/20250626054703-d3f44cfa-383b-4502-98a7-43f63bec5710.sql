...
DROP POLICY IF EXISTS "Users can insert lesson messages" ON public.lesson_messages;
...
-- Corriger la politique pour permettre aux professeurs de mettre à jour les messages
