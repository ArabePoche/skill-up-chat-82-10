import{aR as o,Q as l,U as _}from"./index-CKhToFsG.js";const m=(t,a)=>{const{user:e}=o();return l({queryKey:["teacher-classes",t,a,e==null?void 0:e.id],queryFn:async()=>{if(!t||!a||!(e!=null&&e.id))return[];const{data:n,error:i}=await _.from("class_subjects").select(`
          id,
          coefficient,
          class_id,
          classes!inner (
