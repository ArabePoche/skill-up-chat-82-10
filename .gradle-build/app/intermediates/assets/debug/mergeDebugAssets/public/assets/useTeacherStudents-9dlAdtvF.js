import{aR as l,Q as m,U as _}from"./index-CKhToFsG.js";const f=(a,r)=>{const{user:e}=l();return m({queryKey:["teacher-students",a,r,e==null?void 0:e.id],queryFn:async()=>{if(!a||!r||!(e!=null&&e.id))return[];const{data:t,error:n}=await _.from("class_subjects").select(`
          class_id,
          classes!inner (
            id,
            name,
